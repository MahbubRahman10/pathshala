<template>
    <div>
        ...
        <div class="main-contents">
            ...
            <p class="utitle">All Grade(s) of {{subjectname}}</p>
            ...
            <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
                ...
                <tr v-if="tests.data == ''">      
                    <td class="nodata" colspan='2' v-if="nodata"><p>No Test Available</p></td>
                </tr>
                <tr v-if="loadings">
            ...
            <p> 
                <pagination :data="tests" @pagination-change-page="getgrades">>
    ...
    export default{
        ...
        methods:{
            ...
            getgrades:function(page){
                ...
                axios({
                    method: 'get',
                    url: 'http://localhost:8000/api/pupils/' + this.subjectid + '/?page=' + page,
                    accept: 'json',
                    ContentType: 'json',
                    Authorization: 'Bearer' + this.$cookie.get('token')
                }).then(response => {  
