    ...
    <div>
        <Header></Header>
         <div class="main-contents">
            ...
            <p class="utitle">My Assigned Subject(s)</p>
            <div class="field has-addons">
            </div>
            <table class="table is-bordered is-narrow is-hoverable is-fullwidth is-striped">
                <tr>
                ...
                <tr v-else v-for="(subject,index) in subjects.data">
                    ...
                    <td>
                        <router-link class="button is-link" v-bind:to="'/teacher/subject/' + subject.id">View
                     </router-link>
                    </td>             
                </tr>
            </table>
            <p> 
                <pagination :data="subjects" @pagination-change-page="getallsubjects">>
    ...
    export default{
        ...
        methods:{
            getallsubjects:function(page){
                ...
                axios({
                    method: 'get',
                    url: 'http://localhost:8000/api/teacher/subjects?page=' + page,
                    accept: 'json',
                    ContentType: 'json',
